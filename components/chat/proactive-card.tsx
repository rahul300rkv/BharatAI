    ...
    >
      <div className="relative">
        ...
        <button
          ...
          className="absolute -top-2 -right-2 w-6 h-6 bg-card dark:bg-[#241200] shadow-md border border-gray-100 dark:border-gray-700 rounded-full flex items-center justify-center text-muted-foreground hover:text-red-500 hover:scale-110 transition-all z-20 group/close"
        ...
        {/* Triangle Tail */}
        <div
          className="absolute -bottom-[6px] w-3 h-3 bg-card dark:bg-[#241200] border-b border-r border-gray-100 dark:border-gray-700 z-10"
          style={{
        ...
        {/* Card body */}
        <div className="bg-card/95 dark:bg-card/95 backdrop-blur-sm p-3.5 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.12)] border border-gray-100 dark:border-gray-700 flex flex-col gap-2.5 relative overflow-hidden">
          {/* Progress Bar */}
          <div className="absolute top-0 left-0 right-0 h-1 bg-muted/40/50 dark:bg-card/50">
            <div
          ...
          <div className="flex items-center gap-2 px-0.5 pt-1">
            ...
            <span
              className={`text-[10px] font-bold tabular-nums shrink-0 ${
                isPaused ? 'text-gray-300 dark:text-muted-foreground' : 'text-muted-foreground'
              }`}
            >
            ...
            <button
              ...
              className={`p-2 aspect-square rounded-lg border transition-colors active:scale-90 ${
                isPaused
                  ...
                  : 'bg-muted/40 hover:bg-muted dark:bg-card dark:hover:bg-gray-600 text-muted-foreground hover:text-muted-foreground dark:text-muted-foreground dark:hover:text-gray-300 border-gray-100 dark:border-gray-600'
              }`}
