  ...
  if (notes.length === 0) {
    return (
      <div className="h-full flex flex-col items-center justify-center text-center p-6">
        <div className="w-12 h-12 bg-primary/8 dark:bg-primary/15 rounded-2xl flex items-center justify-center mb-3 text-primary/300 dark:text-primary ring-1 ring-primary/100 dark:ring-primary/800/30">
        ...
        return (
          <div
            ...
            className={cn(
              ...
              isCurrent
                ? 'bg-primary/8 dark:bg-primary/12 ring-1 ring-primary/20 dark:ring-primary/30'
                : 'bg-muted/30 dark:bg-card/30',
            )}
          >
            {/* Page label row */}
            <div className="flex items-center gap-2 mb-1.5">
              ...
              {isCurrent && (
                <span className="text-[9px] font-bold px-1.5 py-px rounded-full bg-primary/12 dark:bg-primary/900/40 text-primary dark:text-primary/300">
              ...
              {(() => {
                ...
                return rows.map((row, i) => {
                  ...
                  return (
                    <p
                      key={i}
                      className="text-[12px] leading-[1.8] text-foreground/80"
                    >
                      {actions.map((a, j) => {
