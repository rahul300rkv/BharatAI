      ...
      <div className="flex gap-1.5 items-center py-1.5 px-1">
        <span
          className={cn(
            ...
            isTeacher
              ? 'bg-primary/70 dark:bg-primary/65'
  ...
  return (
    <div
      className={cn(
        ...
        isUser
          ? 'bg-gradient-to-br from-primary/300 to-primary/350 dark:from-primary/250 dark:to-primary/300 text-white rounded-tr-sm shadow-sm shadow-primary/150/30 dark:shadow-primary/450/50 ring-1 ring-primary/250/20'
          : isTeacher
            ? 'bg-card dark:bg-card text-foreground/90 border border-primary/15 dark:border-gray-700 rounded-tl-sm shadow-sm'
  ...
  if (session.messages.length === 0 && !isActive) {
    return (
      <div className="h-20 flex items-center justify-center text-center px-2">
        <p className="text-[10px] text-muted-foreground">{t('chat.noMessages')}</p>
      </div>
    );
  }
          ...
          return (
            <motion.div
              ...
              className={cn(
                ...
                isActiveBubble &&
                  'border-l-primary/250 dark:border-l-primary/200 bg-primary/8/50 dark:bg-primary/12',
              )}
            >
              {/* Mini Avatar */}
              <div className="w-5 h-5 rounded-full overflow-hidden bg-muted dark:bg-card shrink-0 mt-0.5 ring-1 ring-gray-200/50 dark:ring-gray-700/50">
              ...
              <div className={cn('flex-1 min-w-0', isUser && 'text-right')}>
                <span
                  className={cn(
                    ...
                    isUser
                      ? 'text-primary/250 dark:text-primary'
                      : isTeacher
                        ? 'text-primary/200 dark:text-primary/150'
