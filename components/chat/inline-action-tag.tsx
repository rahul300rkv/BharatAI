...
const WB_STYLE =
  'bg-primary/8 dark:bg-primary/15 border-primary/25 dark:border-primary/30 text-primary dark:text-primary/300';
const WB_ACCENT = 'bg-primary dark:bg-primary';
...
const DEFAULT_STYLE =
  'bg-muted/40 dark:bg-muted/15 border-border/40 dark:border-border/30 text-foreground/80';
  ...
  return (
    ...
    >
      ...
      {isWb && (
        ...
        >
          <PenLine className="w-[7px] h-[7px] text-white dark:text-[#1A0C00]" strokeWidth={2.5} />
        </span>
      )}
