  ...
  (
    ...
    return (
      <div
        ...
        className={cn(
          'bg-[#FFF9F2]/85 dark:bg-[#1E0E00]/85 backdrop-blur-xl border-l border-primary/10 dark:border-primary/y-800 shadow-[-2px_0_24px_rgba(0,0,0,0.02)] flex flex-col shrink-0 z-20 relative overflow-visible',
          className,
        )}
      >
        {/* Drag handle */}
        {!collapsed && (
          <div
            ...
            className="absolute left-0 top-0 bottom-0 w-1.5 cursor-col-resize z-50 group hover:bg-primary/le-400/30 dark:hover:bg-primary/le-600/30 active:bg-primary/80/40 dark:active:bg-primary/80/40 transition-colors"
          >
            <div className="absolute left-0.5 top-1/2 -translate-y-1/2 w-0.5 h-8 rounded-full bg-muted/300 dark:bg-muted/600 group-hover:bg-primary/le-400 dark:group-hover:bg-primary/80 transition-colors" />
          </div>
        )}
            ...
            <div className="h-10 flex items-center gap-1 shrink-0 mt-3 mb-1 px-3">
              ...
              {onCollapseChange && (
                <button
                  ...
                  className="w-7 h-7 shrink-0 rounded-lg flex items-center justify-center bg-muted/100/80 dark:bg-muted/800/80 text-muted-foreground dark:text-muted-foreground ring-1 ring-black/[0.04] dark:ring-white/[0.06] hover:bg-muted/90 dark:hover:bg-muted/700/90 hover:text-gray-700 dark:hover:text-gray-200 active:scale-90 transition-all duration-200"
                >
              ...
              <div className="flex-1 overflow-y-auto overflow-x-hidden p-3 space-y-2 scrollbar-hide">
                {chatSessions.length === 0 ? (
                  <div className="h-full flex flex-col items-center justify-center text-center p-6 opacity-50">
                    <div className="w-12 h-12 bg-muted dark:bg-card rounded-full flex items-center justify-center mb-3 text-gray-300 dark:text-muted-foreground">
