    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          {allRevealed && (
            <motion.button
              className="absolute right-4 top-4 flex size-9 items-center justify-center rounded-full bg-black/5 text-zinc-500 backdrop-blur-sm transition-colors hover:bg-black/10 hover:text-zinc-700 dark:bg-card/10 dark:text-white/70 dark:hover:bg-card/20 dark:hover:text-white"
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {/* Inner card body */}
                        <div className="relative flex size-full flex-col overflow-clip rounded-[14px] bg-card dark:bg-zinc-900">
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <span className="mt-1.5 text-xl font-bold text-primary/50">?</span>
                        </div>
                      </div>
                    </div>
                  </motion.div>
          ...
          >
              ...
              {agents.map((_, index) => (
                <div
                  ...
                  className={cn(
                    ...
                    index < revealedCount
                      ? 'bg-zinc-700 dark:bg-card'
                      : 'bg-zinc-300 dark:bg-card/30',
                  )}
                />
              ))}
            </div>
            ...
            {allRevealed && (
              <motion.button
                className="rounded-full bg-zinc-800 px-6 py-2 text-sm font-medium text-white transition-colors hover:bg-zinc-700 dark:bg-card/15 dark:hover:bg-card/25"
