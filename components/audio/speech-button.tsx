      ...
      <TooltipTrigger asChild>
        <button
          ...
          className={cn(
            ...
            sizeClasses,
            active
              ? 'bg-primary/90 dark:bg-primary/80 text-white shadow-[0_0_12px_rgba(232,101,10,0.45)] dark:shadow-[0_0_12px_rgba(139,92,246,0.3)]'
        ...
        >
          ...
          {isRecording && (
            <span
              className="absolute inset-[-4px] rounded-[10px] border border-primary/30 dark:border-primary/olet-400/25"
              style={{
