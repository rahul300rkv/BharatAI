      ...
      <PopoverTrigger asChild>
        <button
          className={cn(
            ...
            enabledCount > 0
              ? 'bg-primary/10 dark:bg-primary/15 text-primary border-primary/30/60 dark:border-primary/700/50'
            ...
            {TABS.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {isEnabled && !isActive && (
                    <span className="absolute top-1 right-1 size-1.5 rounded-full bg-primary/80" />
                  )}
                </button>
              );
            })}
