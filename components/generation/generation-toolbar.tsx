...
export function GenerationToolbar({
  ...
  const pillActive = `${pillCls} border-primary/30 dark:border-primary/40 bg-primary/10 dark:bg-primary/15 text-primary/700 dark:text-primary/300`;
        ...
        <PopoverTrigger asChild>
          {pdfFile ? (
            <button className={pillActive}>
              ...
              <span
                role="button"
                className="size-4 rounded-full inline-flex items-center justify-center hover:bg-primary/15 dark:hover:bg-primary/800 transition-colors"
                onClick={(e) => {
                  e.stopPropagation();
            ...
            {pdfFile ? (
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <div className="size-8 rounded-lg bg-primary/10 dark:bg-primary/15 flex items-center justify-center shrink-0">
                    <FileText className="size-4 text-primary dark:text-primary" />
                  </div>
              ...
              <div
                className={cn(
                  ...
                  isDragging
                    ? 'border-primary/60 bg-primary/8 dark:bg-primary/15'
          ...
          <PopoverContent align="start" className="w-64 p-3 space-y-3">
            ...
            <button
              ...
              className={cn(
                ...
                webSearch
                  ? 'bg-primary/8 dark:bg-primary/950/20 border-primary/200 dark:border-primary/800'
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          ...
          >
            ...
            <span>{language === 'hi-IN' ? 'हि' : 'EN'}</span>
          </button>
        </TooltipTrigger>
          ...
          <PopoverTrigger asChild>
            <button
              className={cn(
                ...
                currentModelId &&
                  'ring-primary/300 dark:ring-primary/700 bg-primary/8 dark:bg-primary/950/20',
              )}
            >
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    isActive ? 'bg-primary/8/50 dark:bg-primary/950/10' : 'hover:bg-muted/50',
                  )}
                >
                  {provider.icon ? (
                    <img
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    isSelected
                      ? 'bg-primary/8 dark:bg-primary/950/20 text-primary/700 dark:text-primary/300'
                      : 'hover:bg-muted/50',
                  )}
                >
