                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="font-medium text-sm flex items-center gap-1.5">
                      {getAgentName(agent)}
                      {agent.role === 'teacher' && (
                        <span className="text-[10px] px-1.5 py-0.5 rounded bg-primary/10 text-primary dark:bg-primary/900/40 dark:text-primary300 leading-none">
                          {t('settings.required')}
                        </span>
                      )}
                    </div>
              ...
              className={`p-3 rounded-lg text-sm ${
                selectedAgentIds.length === 0
                  ...
                  : selectedAgentIds.length === 1
                    ? 'bg-primary/50 dark:bg-primary/900/20 text-primary700 dark:text-primary300 border border-primary/200 dark:border-primary/800'
                    : 'bg-primary/8 dark:bg-primary/15 text-primary dark:text-primary border border-primary/le-200 dark:border-primary/800'
              }`}
            >
              {selectedAgentIds.length === 0 && (
