...
export function Roundtable({
  ...
  const toolbar = (
    <CanvasToolbar
      className="shrink-0 h-8 px-3 border-b border-border/30"
  ...
  if (isPresenting) {
    return (
      <div className="h-0 w-full relative z-10 overflow-visible">
        ...
        >
          <div className="mb-3 px-2 py-1 rounded-full bg-[#FFF9F2]/80 dark:bg-[#1A0C00]/80 backdrop-blur-xl border border-border/200/60 dark:border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.08)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
            {toolbar}
          </div>
        </div>
        ...
        <AnimatePresence>
          {endFlashVisible && (
            <motion.div
              ...
              className="fixed bottom-20 -translate-x-1/2 z-[50] bg-muted/100/80 dark:bg-muted/800/80 backdrop-blur-md text-muted-foreground700 dark:text-white px-3.5 py-1.5 rounded-full text-xs font-medium pointer-events-none"
              style={{
                left: `calc((100vw - ${chatCollapsed === false ? (chatAreaWidth ?? 320) : 0}px) / 2)`,
              }}
            >
              <span className="w-1.5 h-1.5 rounded-full bg-muted/400 inline-block mr-1.5" />
              {endFlashSessionType === 'discussion'
        ...
        >
          ...
          <AnimatePresence>
            {isInputOpen && (
              ...
              >
                <div className="flex items-center gap-3 bg-[#FFF9F2]/80 dark:bg-[#1A0C00]/80 backdrop-blur-xl rounded-full px-4 py-2 shadow-[0_8px_32px_rgba(0,0,0,0.08)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-border/200/60 dark:border-white/10">
                  <div className="flex-1 min-w-0 flex items-center">
                    <textarea
                      ...
                      autoFocus
                      rows={1}
                      className="w-full resize-none bg-transparent border-none focus:ring-0 focus:outline-none outline-none shadow-none ring-0 text-muted-foreground900 dark:text-white text-sm placeholder:text-muted-foreground400 dark:placeholder:text-muted-foreground400 py-0 leading-[40px] max-h-[80px]"
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isSendCooldown
                        ? 'bg-muted/500/50 cursor-not-allowed'
                        : 'bg-primary hover:bg-primary/90 shadow-[0_4px_16px_rgba(232,101,10,0.35)]',
                    )}
                  >
                    {isSendCooldown ? (
          ...
          <AnimatePresence>
            {isVoiceOpen && (
              ...
              >
                <div className="flex items-center gap-4 bg-[#FFF9F2]/80 dark:bg-[#1A0C00]/80 backdrop-blur-xl rounded-full px-5 py-3 shadow-[0_8px_32px_rgba(0,0,0,0.08)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-border/200/60 dark:border-white/10">
                  {/* Waveform bars */}
                  <div className="flex items-center gap-0.5 h-8">
                    <VoiceWaveformBars barClassName="bg-gradient-to-t from-primary to-[#F5A800]" />
                  </div>
                  ...
                  >
                    <div className="relative w-12 h-12 rounded-full bg-gradient-to-br from-primary to-[#BF4E00] shadow-[0_4px_20px_rgba(147,51,234,0.3)] flex items-center justify-center group-hover:scale-105 transition-transform duration-300 border border-white/20">
          ...
          <AnimatePresence>
            {thinkingState?.stage === 'director' && !currentSpeech && !userMessage && (
              <motion.div
                ...
                className="flex items-center gap-2 px-4 py-2 bg-card/70 dark:bg-[#1A0C00]/50 backdrop-blur-xl rounded-full border border-border/200/60 dark:border-white/10"
              >
            ...
            {showPresentationDock && (
              ...
              >
                <div
                  ...
                  className="flex items-center gap-2.5 rounded-full bg-[#FFF9F2]/80 dark:bg-[#1A0C00]/80 backdrop-blur-xl border border-border/200/60 dark:border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.08)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)] px-2.5 py-2"
                >
                    ...
                    {((activeRole === 'agent' && speakingStudent) ||
                      ...
                      >
                        <div className="relative w-10 h-10 rounded-full flex items-center justify-center">
                          <div className="absolute inset-0 rounded-full border-2 border-primary/500 shadow-[0_0_6px_rgba(59,130,246,0.3)] transition-all duration-300" />
                          <div className="w-8 h-8 rounded-full bg-muted/200 dark:bg-muted/800 overflow-hidden relative z-10 text-lg">
                            <AvatarDisplay
                              src={
                    ...
                    <>
                      <button
                        ...
                        className={cn(
                          ...
                          !asrEnabled
                            ? 'text-muted-foreground500 cursor-not-allowed'
                            : isVoiceOpen
                              ? 'bg-primary text-white'
                              : 'text-muted-foreground500 dark:text-muted-foreground300 hover:text-muted-foreground700 dark:hover:text-white hover:bg-muted/200/50 dark:hover:bg-card/10',
                        )}
                      >
                        ...
                        className={cn(
                          ...
                          isCueUser
                            ...
                            : activeRole === 'user' || isInputOpen
                              ? 'border-primary shadow-[0_0_6px_rgba(232,101,10,0.3)]'
                              : 'border-border/300/40 dark:border-white/20 group-hover:border-primary/400/50',
                        )}
                      />
                      <div className="w-8 h-8 rounded-full bg-muted/200 dark:bg-muted/800 overflow-hidden relative z-10 text-lg">
    ...
    <div
      className={cn(
        ...
        isPresenting && !controlsVisible
          ...
          : 'border-t border-border bg-card/60 dark:bg-[#241200]/60 backdrop-blur-md',
      )}
    >
      ...
      <div className="flex-1 flex items-stretch min-h-0">
        ...
        <div
          className={cn(
            'w-[90px] shrink-0 flex flex-col border-r border-border/100/50 dark:border-border/700/50 bg-card/40 dark:bg-muted/900/40 overflow-visible relative transition-opacity duration-300',
            isPresenting && !controlsVisible && 'opacity-0 pointer-events-none',
          )}
        >
          {/* Decorative Element (Top) */}
          <div className="absolute top-0 inset-x-0 h-16 bg-gradient-to-b from-primary/50/50 dark:from-primary/900/10 to-transparent pointer-events-none" />
          <div className="absolute top-3 inset-x-0 flex flex-col items-center justify-center gap-1 opacity-10 pointer-events-none">
            <BookOpen size={20} className="text-primary/900 dark:text-primary/100" />
            <div className="w-8 h-0.5 bg-primary/900 dark:bg-primary/12 rounded-full" />
          </div>
              ...
              <HoverCard openDelay={300} closeDelay={100}>
                <HoverCardTrigger asChild>
                  <div className="flex flex-col items-center gap-1">
                    ...
                    >
                      <div
                        className={cn(
                          ...
                          activeRole === 'teacher'
                            ? 'border-primary/500 dark:border-primary/400 shadow-[0_0_12px_rgba(168,85,247,0.4)]'
                            : 'border-border group-hover:border-primary/300 dark:group-hover:border-primary/600',
                        )}
                      />

                      <div className="w-10 h-10 rounded-full bg-white dark:bg-muted/800 overflow-hidden relative z-10 shadow-sm border border-border/50 dark:border-border/700">
                        <img
                          src={teacherAvatar}
                          alt={teacherName}
                      ...
                      {activeRole === 'teacher' && (
                        <div className="absolute -right-0.5 top-0.5 w-4 h-4 bg-green-500 dark:bg-green-400 rounded-full border-2 border-white dark:border-border/800 flex items-center justify-center z-20">
                    ...
                    <span
                      className={cn(
                        'max-w-[80px] truncate px-2 py-0.5 rounded-full text-[10px] font-bold tracking-wider uppercase border shadow-sm transition-all duration-300 bg-card/90 dark:bg-muted/800/90',
                        activeRole === 'teacher' && !speakingStudent
                          ? 'text-primary dark:text-primary border-primary/200 dark:border-primary/700'
                          : 'text-muted-foreground border-border group-hover:text-primary/500 dark:group-hover:text-primary/400 group-hover:border-primary/200 dark:group-hover:border-primary/600',
                      )}
                    >
                      {teacherName}
                    </span>
                    ...
                    return (
                      <>
                        <div className="flex items-center gap-2">
                          <div className="w-8 h-8 rounded-full overflow-hidden shrink-0 bg-muted/100 dark:bg-muted/800">
                            <img
                              src={teacherAvatar}
                              alt={teacherName}
                              className="w-full h-full object-cover"
          ...
          <AnimatePresence>
            {endFlashVisible && (
              <motion.div
                ...
                className="absolute top-1 left-1/2 -translate-x-1/2 z-50 bg-muted/800/80 backdrop-blur-md text-white px-3.5 py-1.5 rounded-full text-xs font-medium pointer-events-none"
              >
                <span className="w-1.5 h-1.5 rounded-full bg-muted/400 inline-block mr-1.5" />
                {endFlashSessionType === 'discussion'
                  ? t('roundtable.discussionEnded')
          ...
          >
            ...
            <AnimatePresence>
              {isInputOpen && (
                ...
                >
                  <div className="relative w-fit max-w-[85%] sm:max-w-[65%] min-w-[200px] sm:min-w-[300px] bg-card/90 dark:bg-muted/800/90 backdrop-blur-md p-2 pr-2 rounded-2xl rounded-br-none shadow-2xl border border-primary/200 dark:border-primary/700 flex items-end gap-2 ring-1 ring-primary/100/50 dark:ring-primary/800/50">
                    <div className="pl-4 flex-1 py-1 min-w-0">
                      <textarea
                        ...
                        autoFocus
                        rows={1}
                        className="w-full resize-none bg-transparent border-none focus:ring-0 focus:outline-none outline-none shadow-none ring-0 text-foreground text-sm placeholder:text-muted-foreground400 dark:placeholder:text-muted-foreground500 min-h-[40px] max-h-[120px]"
                        style={{ fieldSizing: 'content' } as Record<string, string>}
                      />
                    </div>
                    <button
                      ...
                      className={cn(
                        ...
                        isSendCooldown
                          ? 'bg-muted/400 dark:bg-muted/600 cursor-not-allowed shadow-gray-200 dark:shadow-gray-900/50'
                          : 'bg-primary/600 hover:bg-primary/700 dark:bg-primary/80 dark:hover:bg-primary/600 shadow-primary/200 dark:shadow-primary/900/50',
                      )}
                    >
                      {isSendCooldown ? (
              ...
              {isVoiceOpen && (
                ...
                >
                  <div className="flex flex-col-reverse items-end gap-1 mr-[-10px] relative z-20">
                    <div className="flex items-center gap-0.5 h-8 px-2 py-1.5 bg-card/80 dark:bg-[#241200]/80 backdrop-blur-md rounded-xl border border-primary/100 dark:border-primary/800 shadow-sm">
                      <VoiceWaveformBars barClassName="bg-gradient-to-t from-primary/500 to-indigo-600 dark:from-primary/400 dark:to-primary" />
                    </div>
                    <motion.div
                      initial={{ opacity: 0, x: 10 }}
                      animate={{ opacity: 1, x: 0 }}
                      className="text-[10px] font-bold tracking-widest text-primary dark:text-primary uppercase bg-card/90 dark:bg-muted/800/90 backdrop-blur-sm px-2 py-0.5 rounded-full shadow-sm border border-primary/100/50 dark:border-primary/800/50 mr-1"
                    >
                      {isProcessing ? t('roundtable.processing') : t('roundtable.listening')}
                    </motion.div>
                  </div>
                  ...
                  <div
                    ...
                    onClick={handleToggleVoice}
                  >
                    <div className="relative w-16 h-16 rounded-full bg-gradient-to-br from-primary to-[#BF4E00] dark:from-primary/500 dark:to-indigo-600 shadow-[0_4px_20px_rgba(147,51,234,0.3)] flex items-center justify-center z-20 group-hover:scale-105 transition-transform duration-300 border border-white/20 dark:border-white/10">
                      <Mic className="w-6 h-6 text-white" />
                    </div>
                    <div className="absolute inset-0 rounded-full border-2 border-primary/500 dark:border-primary/400 opacity-40 animate-[ping_2s_ease-in-out_infinite] z-10" />
                    <div className="absolute inset-0 rounded-full border border-primary dark:border-indigo-300 opacity-20 animate-[ping_3s_ease-in-out_infinite_0.5s] z-10" />
                    <div className="absolute inset-0 bg-primary/600 dark:bg-primary/80 blur-2xl opacity-20 group-hover:opacity-40 transition-opacity z-0" />
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
            ...
            <AnimatePresence>
              {thinkingState?.stage === 'director' && !currentSpeech && !userMessage && (
                <motion.div
                  ...
                  animate={{ opacity: 1, scale: 1 }}
                  exit={{ opacity: 0, scale: 0.9 }}
                  className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 flex items-center gap-2 px-4 py-2 bg-card/90 dark:bg-muted/800/90 backdrop-blur-md rounded-full shadow-sm border border-border"
                >
                  <div className="flex gap-1">
                    <motion.div
                      animate={{ opacity: [0.3, 1, 0.3] }}
                    ...
                    <div
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'bg-primary/[0.08] dark:bg-primary/80/[0.06]',
                      )}
                    />
                    ...
                    <motion.div
                      ...
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'border-primary/400/50 dark:border-primary/500/35',
                      )}
                    />
                    {/* Expanding ripple 2 */}
                    <motion.div
                      ...
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'border-primary/300/40 dark:border-primary/400/25',
                      )}
                    />
                    ...
                    <motion.button
                      ...
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'from-primary/400 to-primary dark:from-primary/500 dark:to-indigo-600 shadow-primary/400/30 dark:shadow-primary/600/20 hover:shadow-primary/400/40 dark:hover:shadow-primary/600/30',
                      )}
                    >
                      {asrEnabled ? (
                    ...
                    <div className="flex items-center justify-center gap-[3px] h-3">
                      {[0, 1, 2, 3, 2, 1, 0].map((intensity, i) => (
                        <motion.div
                          ...
                          className="w-[2.5px] h-full origin-center rounded-full bg-primary/60 dark:bg-primary/80/50"
                        />
                      ))}
                    </div>
                  )}
                  ...
                  >
                    <div
                      ...
                      className={cn(
                        ...
                        bubbleRole === 'user'
                          ? 'bg-primary/600/95 dark:bg-primary/80/95 backdrop-blur-sm border-primary/400/40 dark:border-primary/300/40 text-white rounded-br-sm shadow-md shadow-primary/300/30 dark:shadow-primary/800/30'
                          : bubbleRole === 'agent'
                            ? cn(
                                'bg-primary/50/95 dark:bg-primary/950/60 backdrop-blur-sm border-primary/200/60 dark:border-primary/800/60 text-foreground rounded-br-sm shadow-sm',
                                (isInLiveFlow || isTopicPending) &&
                                  'hover:shadow-md cursor-pointer',
                              )
                            : 'bg-white dark:bg-muted/800 border-border text-foreground rounded-bl-sm shadow-sm hover:shadow-md cursor-pointer',
                      )}
                    >
                      {bubbleRole &&
                        (() => {
                      ...
                      {bubbleRole !== 'user' &&
                        ...
                        (() => {
                          ...
                          const barsColor =
                            bubbleRole === 'agent' ? 'bg-primary/500' : 'bg-primary/80';

                          if (btnState === 'none') return null;

                          if (btnState === 'play') {
                            return (
                              <div className="absolute right-2.5 bottom-2.5 p-1.5 rounded-full bg-muted/50/80 dark:bg-muted/700/80 hover:bg-primary/12 dark:hover:bg-primary/900/50 group-hover/bubble:bg-primary/12 dark:group-hover/bubble:bg-primary/900/50 transition-all duration-300 cursor-pointer">
                                <Play className="w-3.5 h-3.5 text-muted-foreground hover:text-primary dark:hover:text-primary/400 group-hover/bubble:text-primary dark:group-hover/bubble:text-primary/400 ml-0.5" />
                              </div>
                            );
                          }
                          ...
                          if (btnState === 'restart') {
                            return (
                              <div className="absolute right-2.5 bottom-2.5 p-1.5 rounded-full bg-muted/50/80 dark:bg-muted/700/80 hover:bg-primary/12 dark:hover:bg-primary/900/50 group-hover/bubble:bg-primary/12 dark:group-hover/bubble:bg-primary/900/50 transition-all duration-300 cursor-pointer">
                                <Repeat className="w-3.5 h-3.5 text-muted-foreground hover:text-primary dark:hover:text-primary/400 group-hover/bubble:text-primary dark:group-hover/bubble:text-primary/400" />
                              </div>
                            );
                          }
                          ...
                          // btnState === 'bars'
                          return (
                            <div className="absolute right-2.5 bottom-2.5 p-1.5 rounded-full bg-muted/50/80 dark:bg-muted/700/80 group-hover/bubble:bg-primary/12 dark:group-hover/bubble:bg-primary/900/50 transition-all duration-300">
                              {isDiscussionPaused ? (
                                /* Paused: static Play icon */
                                <Play className="w-3.5 h-3.5 text-amber-500 dark:text-amber-400 group-hover/bubble:text-primary dark:group-hover/bubble:text-primary/400 ml-0.5" />
                              ) : (
                                <>
        ...
        <div
          className={cn(
            'w-[140px] shrink-0 flex flex-col py-3 border-l border-border/100/50 dark:border-border/700/50 bg-muted/50/30 dark:bg-muted/900/30 overflow-visible transition-opacity duration-300',
            isPresenting && !controlsVisible && 'opacity-0 pointer-events-none',
          )}
        >
          ...
          <div className="flex-none relative group/scroll">
            ...
            >
              <ChevronLeft className="w-3.5 h-3.5 text-muted-foreground400" />
            </button>
                          ...
                          >
                            <div
                              className={cn(
                                'absolute inset-0 rounded-full border-2 transition-all duration-300',
                                isSpeaking
                                  ? 'border-primary/500 dark:border-primary/400 shadow-[0_0_8px_rgba(168,85,247,0.4)]'
                                  : 'border-white dark:border-border/700',
                              )}
                            />
                            <div className="absolute inset-0.5 rounded-full bg-muted/100 dark:bg-muted/800 overflow-hidden">
                              <img
                                src={student.avatar}
                                alt={student.name}
                            ...
                            {/* Speaking indicator */}
                            {isSpeaking && (
                              <div className="absolute -right-0.5 -top-0.5 w-3 h-3 bg-green-500 rounded-full border border-white dark:border-border/800 z-20 flex items-center justify-center">
                                <div className="w-1 h-1 bg-white rounded-full animate-pulse" />
                              </div>
                            )}
                            {/* Loading indicator (Issue 5) */}
                            {isThinkingAgent && (
                              <div className="absolute inset-0 rounded-full border-2 border-primary/400 border-t-transparent animate-spin z-20" />
                            )}
                          </div>
                        </HoverCardTrigger>
                        <HoverCardContent
            ...
            >
              <ChevronRight className="w-3.5 h-3.5 text-muted-foreground400" />
            </button>
          ...
          {/* Divider */}
          <div className="mx-auto my-1.5 w-8 h-px bg-muted/200 dark:bg-muted/700 opacity-50 shrink-0" />
                  ...
                  <div className="flex items-center gap-[3px]">
                    {[0, 1, 2].map((i) => (
                      <motion.div
                        ...
                        className="w-[4px] h-[4px] rounded-full bg-primary dark:bg-primary"
                      />
                    ))}
                  </div>
                </div>
                ...
                <>
                  <button
                    ...
                    className={cn(
                      ...
                      !asrEnabled
                        ? 'bg-muted/100 dark:bg-muted/800/50 text-muted-foreground300 dark:text-muted-foreground600 border-border cursor-not-allowed'
                        : isVoiceOpen
                          ? 'bg-primary/600 dark:bg-primary/80 border-primary/600 dark:border-primary/500 text-white shadow-primary/200 dark:shadow-primary/800'
                          : 'bg-white dark:bg-muted/800 border-border text-muted-foreground hover:bg-primary/8 dark:hover:bg-primary/900/20 hover:text-primary dark:hover:text-primary/400 hover:border-primary/200 dark:hover:border-primary/700',
                    )}
                  >
                    {asrEnabled ? (
                ...
                <div
                  className={cn(
                    ...
                    isCueUser
                      ...
                      : activeRole === 'user' || isInputOpen
                        ? 'border-primary/600 dark:border-primary/400 shadow-[0_0_8px_rgba(168,85,247,0.3)]'
                        : 'border-white dark:border-border/700 group-hover:border-primary/200 dark:group-hover:border-primary/600',
                  )}
                />
                <div className="w-14 h-14 rounded-full bg-muted/50 dark:bg-card overflow-hidden relative z-10 shadow-sm border border-border/50 dark:border-border/700 text-2xl">
                  <AvatarDisplay src={userAvatar} alt={t('roundtable.you')} />
                </div>
                <div className="absolute top-0 right-0 w-5 h-5 bg-white dark:bg-muted/800 rounded-full flex items-center justify-center shadow-md border border-border z-20">
                  <div
                    className={cn(
                      'w-1.5 h-1.5 rounded-full',
