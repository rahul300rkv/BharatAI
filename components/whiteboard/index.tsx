      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute inset-4 pointer-events-auto bg-card/95 dark:bg-[#241200]/95 backdrop-blur-2xl rounded-3xl shadow-[0_32px_80px_-20px_rgba(0,0,0,0.25)] border-2 border-primary/200/60 dark:border-primary/700/60 flex flex-col overflow-hidden z-[120] ring-4 ring-primary/100/40 dark:ring-primary/800/40"
          >
            {/* Header */}
            <div className="h-14 px-6 border-b border-border flex items-center justify-between shrink-0 bg-white/50 dark:bg-muted/800/50">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-xl bg-primary/12 dark:bg-primary/20 flex items-center justify-center text-primary dark:text-primary">
              ...
              <div className="flex items-center gap-2">
                <AnimatePresence>
                  {viewModified && (
                    <motion.button
                      ...
                      whileTap={{ scale: 0.9 }}
                      className="p-2 text-muted-foreground dark:text-muted-foreground hover:text-primary dark:hover:text-primary 400 hover:bg-primary/8 dark:hover:bg-primary/900/20 rounded-lg transition-colors"
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="p-2 text-muted-foreground dark:text-muted-foreground hover:text-red-500 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors disabled:opacity-40 disabled:pointer-events-none"
                ...
                <div className="relative">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="relative p-2 text-muted-foreground dark:text-muted-foreground hover:text-primary dark:hover:text-primary 400 hover:bg-primary/8 dark:hover:bg-primary/900/20 rounded-lg transition-colors"
                    title={t('whiteboard.history')}
                  >
                    <History className="w-4 h-4" />
                    {snapshotCount > 0 && (
                      <span className="absolute -top-0.5 -right-0.5 min-w-[16px] h-4 px-1 rounded-full bg-primary/80 text-white text-[10px] font-bold flex items-center justify-center">
                        {snapshotCount}
                      </span>
                    )}
                  </motion.button>
                ...
                <div className="w-px h-4 bg-muted/200 dark:bg-muted/700 mx-1" />
                <button
                  type="button"
                  onClick={onClose}
                  className="p-2 text-muted-foreground dark:text-muted-foreground hover:text-muted-foreground800 dark:hover:text-muted-foreground200 hover:bg-muted/100 dark:hover:bg-muted/700 rounded-lg transition-colors"
