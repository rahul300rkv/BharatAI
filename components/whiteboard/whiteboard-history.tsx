    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="absolute right-0 top-full mt-2 z-[130] w-72 max-h-80 bg-card dark:bg-[#241200] rounded-xl shadow-2xl border border-border overflow-hidden flex flex-col"
        >
          {/* Header */}
                ...
                {[...snapshots].reverse().map((snap, reverseIdx) => {
                  ...
                  return (
                    <div
                      ...
                      className="px-4 py-2.5 flex items-center justify-between hover:bg-primary/6 dark:hover:bg-primary/ray-700/50 transition-colors group"
                    >
                      ...
                      <button
                        ...
                        disabled={isClearing}
                        className="ml-2 px-2 py-1 text-xs text-primary dark:text-primary hover:bg-primary/8 dark:hover:bg-primary/10 rounded-md opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-transparent"
                      >
