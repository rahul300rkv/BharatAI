...
export function CanvasArea({
  ...
  return (
    <div className="w-full h-full flex flex-col bg-muted/40 dark:bg-[#1E0E00] group/canvas">
      ...
      <div
        className={cn(
          ...
          currentScene?.type === 'interactive'
            ...
            : 'bg-muted/40/30 dark:bg-[#1E0E00]/30',
        )}
      >
        <div
          className={cn(
            'aspect-[16/9] h-full max-h-full max-w-full bg-card dark:bg-[#241200] shadow-2xl rounded-lg overflow-hidden relative transition-all duration-700',
        ...
        >
          ...
          <AnimatePresence>
            {isPendingScene && !currentScene && (
              <motion.div
                ...
                className="absolute inset-0 z-[105] flex flex-col items-center justify-center bg-card dark:bg-[#241200]"
              >
                {isGenerationFailed ? (
                  ...
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="relative w-12 h-12">
                      <div className="absolute inset-0 rounded-full border-2 border-border dark:border-border/0" />
          ...
          {/* Scene Number Badge */}
          {currentScene && (
            <div className="absolute top-4 right-4 text-gray-200 dark:text-foreground/90 font-black text-4xl opacity-50 pointer-events-none select-none mix-blend-multiply dark:mix-blend-screen">
              ...
              >
                ...
                >
                  <motion.div
                    ...
                    className="w-20 h-20 rounded-full bg-card/95 dark:bg-card/95 flex items-center justify-center shadow-[0_4px_30px_rgba(147,51,234,0.15),inset_0_0_0_1px_rgba(233,213,255,0.5)] dark:shadow-[0_4px_30px_rgba(147,51,234,0.3),inset_0_0_0_1px_rgba(126,34,206,0.3)]"
                    style={{ willChange: 'transform' }}
                  >
                    <Play className="w-7 h-7 text-primary dark:text-primary fill-primary/90 dark:fill-primary/e-400/90 ml-0.5" />
                  </motion.div>
                </motion.div>
              </motion.div>
            )}
      ...
      {!hideToolbar && (
        <CanvasToolbar
          className={cn(
            'shrink-0 h-9 px-2',
            'bg-card/80 dark:bg-[#241200]/80 backdrop-blur-xl',
            'border-t border-border/200/40 dark:border-border/700/40',
          )}
