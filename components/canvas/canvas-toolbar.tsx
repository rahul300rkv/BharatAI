...
const ctrlBtn = cn(
  ...
  'hover:bg-primary/8 dark:hover:bg-primary/10 active:scale-90',
);

/* Subtle separator */
function CtrlDivider() {
  return <div className="w-px h-3 bg-border dark:bg-border mx-0.5 shrink-0" />;
}
        ...
        <div
          className={cn(
            ...
            isPresenting
              ...
              : 'bg-muted/60 dark:bg-card/60 rounded-lg',
          )}
        >
          ...
          {onToggleMute && (
            ...
            >
              ...
              >
                <div className="bg-card dark:bg-[#241200] border border-border rounded-lg shadow-lg px-2 py-2.5 flex flex-col items-center gap-1.5">
                  ...
                  <input
                    ...
                    className={cn(
                      ...
                      '[&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-primary/80 [&::-webkit-slider-thumb]:dark:bg-primary/400',
                      '[&::-webkit-slider-thumb]:shadow-sm [&::-webkit-slider-thumb]:cursor-pointer',
                      '[&::-moz-range-thumb]:w-3 [&::-moz-range-thumb]:h-3',
                      '[&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-primary/80 [&::-moz-range-thumb]:border-0',
                    )}
                  />
                </div>
                {/* Arrow pointing down */}
                <div className="w-2 h-2 bg-card dark:bg-[#241200] border-b border-r border-border rotate-45 -mt-[5px]" />
              </div>
            </div>
          )}
                ...
                <TooltipTrigger asChild>
                  <button
                    ...
                    className={cn(
                      ...
                      'active:scale-90',
                      playbackSpeed !== 1
                        ? 'text-primary dark:text-primary bg-primary/10 dark:bg-primary/12'
