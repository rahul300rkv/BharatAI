...
export function ThumbnailSlide({
  ...
  if (!visible) {
    return (
      <div
        className="thumbnail-slide bg-card overflow-hidden select-none"
        style={{
          width: `${size}px`,
          height: `${size * viewportRatio}px`,
        }}
      >
        <div className="placeholder w-full h-full flex justify-center items-center text-muted-foreground text-sm">
          加载中 ...
        </div>
      </div>
    );
