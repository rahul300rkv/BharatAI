    ...
    >
      <div className="w-full h-full" style={{ transform: `rotate(${elementInfo.rotate}deg)` }}>
        ...
        >
          ...
          >
            {showDisabled ? (
              <div className="w-full h-full bg-muted/40 dark:bg-[#1A0C00]/40 flex items-center justify-center">
                <div className="flex items-center gap-1 px-2 py-1 text-[10px] font-medium text-muted-foreground dark:text-muted-foreground ay-400">
