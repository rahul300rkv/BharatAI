...
export function Ruler({ viewportStyles, elementList }: RulerProps) {
  ...
  return (
    <div className="ruler text-xs">
      {/* Ruler corner */}
      <div
        className="corner absolute bg-card border border-border w-5 h-5"
        style={{
      ...
      {/* Horizontal ruler */}
      <div
        className="h absolute bg-card border border-border h-5 flex justify-between items-center overflow-hidden"
        style={{
      ...
      >
        {markers.map((marker) => (
          ...
          >
            ...
            {/* Major tick mark */}
            <div className="absolute right-0 bottom-0 w-[0.1px] h-3 bg-muted-foreground/50 last:content-none" />
            {/* Minor tick mark (50) */}
            <div className="absolute right-1/2 bottom-0 w-[0.1px] h-2 bg-muted-foreground/50" />
          </div>
        ))}
      ...
      {/* Vertical ruler */}
      <div
        className="v absolute bg-card border border-border w-5 overflow-hidden"
        style={{
      ...
      >
        {markers.map((marker) => (
          ...
          >
            ...
            {/* Major tick mark */}
            <div className="absolute bottom-0 right-0 h-[0.1px] w-3 bg-muted-foreground/50 last:content-none" />
            {/* Minor tick mark (50) */}
            <div className="absolute bottom-1/2 right-0 h-[0.1px] w-2 bg-muted-foreground/50" />
          </div>
        ))}
