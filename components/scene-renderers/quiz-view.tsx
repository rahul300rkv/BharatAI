  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center gap-4 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="w-16 h-16 bg-gradient-to-br from-primary/10 to-[#F5A800]/8 dark:from-primary/15 dark:to-primary/900/30 rounded-2xl flex items-center justify-center shadow-lg shadow-primary/100 dark:shadow-primary/900/30 ring-1 ring-primary/200/50 dark:ring-primary/700/50"
      >
      ...
      >
        <div className="flex items-center gap-2 text-muted-foreground">
          <div className="w-7 h-7 rounded-lg bg-primary/8 dark:bg-primary/15 flex items-center justify-center">
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        onClick={onStart}
        className="mt-1 px-8 py-2.5 bg-gradient-to-r from-primary to-[#BF4E00] text-white rounded-full font-medium shadow-lg shadow-primary/200/50 dark:shadow-primary/900/50 hover:shadow-primary/300/50 transition-shadow z-10 flex items-center gap-2"
      >
        {t('quiz.startQuiz')}
          ...
          return (
            <button
              ...
              className={cn(
                ...
                !isReview &&
                  !selected &&
                  'border-border hover:border-primary/40 dark:hover:border-primary/40 hover:bg-primary/8/50 dark:hover:bg-primary/15',
                !isReview &&
                  selected &&
                  'border-primary/60 bg-primary/8 dark:bg-primary/15 ring-1 ring-primary/200 dark:ring-primary/700',
                // Review states
                isReview &&
                  isCorrectOpt &&
            ...
            >
              <span
                className={cn(
                  ...
                  !isReview && selected && 'bg-primary/80 text-white',
              ...
              <span
                className={cn(
                  'flex-1',
                  isReview && !isCorrectOpt && !selected && 'text-muted-foreground',
                )}
              >
                {opt.label}
              </span>
          ...
          return (
            ...
            >
              <span
                className={cn(
                  ...
                  !isReview &&
                    !isSelected &&
                    'bg-muted dark:bg-card text-muted-foreground',
                  !isReview && isSelected && 'bg-primary/80 text-white',
                  isReview && isCorrectOpt && 'bg-emerald-500 text-white',
              ...
              <span
                className={cn(
                  'flex-1',
                  isReview && !isCorrectOpt && !isSelected && 'text-muted-foreground',
                )}
              >
                {opt.label}
              </span>
      ...
      {!isReview ? (
        <div className="relative">
          <textarea
            ...
            className="w-full min-h-[100px] p-3 pb-10 rounded-xl border border-border/200 dark:border-border/600 text-sm resize-none focus:outline-none focus:border-primary/50 dark:focus:border-primary/600 focus:ring-2 focus:ring-primary/100 dark:focus:ring-primary/900/50 transition-all disabled:bg-muted/50 dark:disabled:bg-muted/800 disabled:text-muted-foreground500 dark:bg-muted/800/50 dark:text-muted-foreground200 dark:placeholder:text-muted-foreground500"
          />
          <SpeechButton
            size="sm"
            disabled={disabled}
          ...
          />
          <span className="absolute bottom-3 right-3 text-xs text-muted-foreground300 dark:text-muted-foreground600">
            {(value ?? '').length} {t('quiz.charCount')}
          </span>
        </div>
      ) : (
        <div className="space-y-3">
          <div className="p-3 rounded-xl bg-muted/50 dark:bg-card/60/50 border border-border/100 dark:border-border/700 text-sm text-muted-foreground700 dark:text-muted-foreground300">
          ...
          {result.aiComment && (
            <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-primary/8 dark:bg-primary/15 border border-primary/100 dark:border-primary/800">
              <Sparkles className="w-4 h-4 text-primary shrink-0 mt-0.5" />
              <div>
                <p className="text-xs font-medium text-primary dark:text-primary mb-0.5">
                  {t('quiz.aiComment')}
                </p>
              ...
              <span className="ml-auto text-xs font-bold text-primary dark:text-primary shrink-0">
...
function QuestionCard({
  ...
  return (
    <motion.div
      ...
      className={cn(
        'bg-card dark:bg-card rounded-2xl border p-5 relative overflow-hidden',
        !isReview && 'border-border/150 dark:border-border/700 shadow-sm',
        isReview &&
        ...
        <div className="flex items-start gap-3">
          <span
            className={cn(
              ...
              !isReview &&
                'bg-primary/10 dark:bg-primary/900/50 text-primary dark:text-primary',
              isReview &&
                result.status === 'correct' &&
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground400 mt-0.5">
    ...
    <div className="w-full h-full bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-900 overflow-hidden flex flex-col">
      <AnimatePresence mode="wait">
        ...
        {phase === 'answering' && (
          ...
          >
            {/* Header bar */}
            <div className="flex items-center justify-between px-6 py-3 border-b border-border/100 dark:border-border/700 bg-white/80 dark:bg-muted/900/80 backdrop-blur shrink-0">
              <div className="flex items-center gap-2">
                <PieChart className="w-4 h-4 text-primary" />
                <span className="text-sm font-semibold text-foreground">
                  {t('quiz.answering')}
                </span>
                <span className="text-xs text-muted-foreground400 ml-1">
                  {
              ...
              <button
                ...
                className={cn(
                  ...
                  allAnswered
                    ? 'bg-gradient-to-r from-primary/500 to-primary/60 text-white shadow-sm hover:shadow-md hover:shadow-primary/200/50 dark:hover:shadow-primary/900/50 active:scale-[0.97]'
        ...
        {phase === 'grading' && (
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground400 mt-1">{t('quiz.aiGradingWait')}</p>
            </div>
        ...
        {phase === 'reviewing' && (
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-3 border-b border-border/100 dark:border-border/700 bg-white/80 dark:bg-muted/900/80 backdrop-blur shrink-0">
              ...
              <button
                onClick={handleRetry}
                className="flex items-center gap-1.5 text-xs text-muted-foreground hover:text-primary dark:hover:text-primary transition-colors"
              >
