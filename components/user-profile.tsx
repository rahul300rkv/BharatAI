...
export function UserProfileCard() {
  ...
  if (!hydrated) {
    return (
      <Card className="p-5 !gap-0 shadow-xl border-muted/40 backdrop-blur-xl bg-card/80 dark:bg-background/80">
  ...
  return (
    <Card className="p-5 !gap-0 shadow-xl border-muted/40 backdrop-blur-xl bg-card/80 dark:bg-background/80">
      ...
      <div className="flex items-center gap-3.5">
        ...
        >
          <div className="size-11 rounded-full bg-muted/40 dark:bg-card overflow-hidden ring-2 ring-primary/150/50 dark:ring-primary/40 group-hover/avatar:ring-primary dark:group-hover/avatar:ring-primary/250 transition-all">
            <img src={avatar} alt="" className="size-full object-cover" />
          </div>
          <div className="absolute -bottom-0.5 -right-0.5 size-4 rounded-full bg-card dark:bg-card border border-muted/60 flex items-center justify-center">
            <ChevronDown
              className={cn(
          ...
          {editingName ? (
            <div className="flex items-center gap-1.5">
              <input
                ...
                className="flex-1 min-w-0 h-7 bg-transparent border-b-2 border-primary dark:border-primaryet-500 text-sm font-semibold text-foreground outline-none placeholder:text-muted-foreground/40"
              />
              <button
                onClick={commitName}
                className="shrink-0 size-6 rounded-md flex items-center justify-center text-primary hover:bg-primary/10 dark:hover:bg-primary/15 transition-colors"
              >
            ...
            <div className="pt-3 pb-1 px-1 flex items-center gap-1.5 flex-wrap">
              {AVATAR_OPTIONS.map((url) => (
                <button
                  ...
                  className={cn(
                    'size-8 rounded-full overflow-hidden bg-muted/40 dark:bg-card cursor-pointer transition-all duration-150',
                    'hover:scale-110 active:scale-95',
                    avatar === url
                      ? 'ring-2 ring-primary dark:ring-primary ring-offset-1 ring-offset-white dark:ring-offset-slate-900'
              ...
              <label
                ...
                className={cn(
                  ...
                  isCustomAvatar(avatar)
                    ? 'ring-2 ring-primary dark:ring-primary ring-offset-1 ring-offset-white dark:ring-offset-slate-900 border-primary/50 dark:border-primary/60 bg-primary/8 dark:bg-primary/15'
