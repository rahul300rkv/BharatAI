...
const DATABASE_NAME = 'BharatAI-Database';
const _DATABASE_VERSION = 8;

/**
 * BharatAI Database Instance
 */
class BharatAIDatabase extends Dexie {
  // Table definitions
...
export const db = new BharatAIDatabase();
