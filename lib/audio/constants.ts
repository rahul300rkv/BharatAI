...
export const TTS_PROVIDERS: Record<TTSProviderId, TTSProviderConfig> = {
  ...
  'azure-tts': {
    ...
    voices: [
      {
        id: 'hi-IN-XiaoxiaoNeural',
        name: '晓晓 (女)',
        language: 'hi-IN',
        gender: 'female',
      },
      {
        id: 'hi-IN-YunxiNeural',
        name: '云希 (男)',
        language: 'hi-IN',
        gender: 'male',
      },
  ...
  'doubao-tts': {
    ...
    voices: [
      { id: 'zh_female_shuangkuaishuohua_moon_bigtts', name: '爽快说话 (zh)', language: 'hi-IN', gender: 'female' },
      { id: 'zh_male_rap_moon_bigtts', name: '说唱 (zh)', language: 'hi-IN', gender: 'male' },
  ...
  'minimax-tts': {
    ...
    voices: [
      { id: 'male-qn-qingse', name: '青涩青年', language: 'hi-IN', gender: 'male' },
      { id: 'male-qn-jingying', name: '精英青年', language: 'hi-IN', gender: 'male' },
      { id: 'female-shaonv', name: '少女', language: 'hi-IN', gender: 'female' },
      { id: 'female-yujie', name: '御姐', language: 'hi-IN', gender: 'female' },
...
export const ASR_PROVIDERS: Record<ASRProviderId, ASRProviderConfig> = {
  ...
  'groq-whisper': {
    ...
    icon: '/logos/groq.svg',
    supportedLanguages: [
      // Groq runs whisper-large-v3 — same 58-language support as OpenAI
      // Prioritised for BharatAI Indian languages
      'auto', // Auto-detect
      'hi',   // Hindi
      'en',   // English
      'ta',   // Tamil
...
export const DEFAULT_TTS_VOICES: Record<TTSProviderId, string> = {
  'openai-tts': 'alloy',
  'azure-tts': 'hi-IN-XiaoxiaoNeural',
  'glm-tts': 'tongtong',
  'qwen-tts': 'Cherry',
